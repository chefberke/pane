...
import { loadCanvasState, saveCanvasState } from './features/canvas/utils/storage';
...
export default function Home() {
  ...
  // Show blank while checking auth / redirecting
  if (isLoading || user) {
    return <div className="w-screen h-screen" style={{ background: 'var(--color-canvas)' }} />;
  }
